...
bgHHMM = bgTime.toString("HHmm");
bgDay = bgTime.toString("EEE");
agentOnline = false;
if(bgDay == "Mon" && bgHHMM >= "1000" && bgHHMM < "2100") { agentOnline = true; }
if(bgDay == "Tue" && bgHHMM >= "1000" && bgHHMM < "1900") { agentOnline = true; }
if(bgDay == "Wed" && bgHHMM >= "1000" && bgHHMM < "1900") { agentOnline = true; }
if(bgDay == "Thu" && bgHHMM >= "1000" && bgHHMM < "2100") { agentOnline = true; }
if(bgDay == "Fri" && bgHHMM >= "1000" && bgHHMM < "2100") { agentOnline = true; }
if(bgDay == "Sat" && bgHHMM >= "0930" && bgHHMM < "1830") { agentOnline = true; }
