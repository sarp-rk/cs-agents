...
if(!agentOnline && replyText.contains("TRANSFER"))
{
	...
	if(cleanText == "")
	{
		cleanText = "Our support team is currently offline. Please contact us at support@romuscasino.com and we will get back to you as soon as possible.";
	}
	offlineReply = Map();
